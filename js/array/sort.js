 ...
 * 冒泡排序
 * 第一轮排序过程
 * [10, 2, 3, 1, 5, 4, 6, 9, 7, 8]
 * [2, 10, 3, 1, 5, 4, 6, 9, 7, 8]
 * [2, 3, 10, 1, 5, 4, 6, 9, 7, 8]
 * [2, 3, 1, 10, 5, 4, 6, 9, 7, 8]
 * [2, 3, 1, 5, 10, 4, 6, 9, 7, 8]
 * [2, 3, 1, 5, 4, 10, 6, 9, 7, 8]
 * [2, 3, 1, 5, 4, 6, 10, 9, 7, 8]
 * [2, 3, 1, 5, 4, 6, 9, 10, 7, 8]
 * [2, 3, 1, 5, 4, 6, 9, 7, 10, 8]
 ...
 * 解析：快速排序是对冒泡排序的一种优化
 * 1. 先取数组中间位置的 值
 * 2. 然后将数组中的的值与中间值比较，大的值放在右侧，小的值左侧，依次 递归 调用，在两边都实行 递归 调用
 */
function quick(arr = []) {
  if (arr.length <= 1) {
    return arr
